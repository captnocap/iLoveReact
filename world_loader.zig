...
const wl_geometry = @import("framework/world_loader/geometry.zig");
...
pub const Runtime = struct {
    ...
    fn build(self: *Runtime) !void {
        ...
        self.cube = buildCube();
        self.sticker_quad_x = wl_geometry.buildStickerQuad(0);
        self.sticker_quad_y = wl_geometry.buildStickerQuad(1);
        self.sticker_quad_z = wl_geometry.buildStickerQuad(2);
