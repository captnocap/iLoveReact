...
pub const MAX_MOTION_LAYERS = implementation.MAX_MOTION_LAYERS;
pub const MOTION_BLEND_IN_SECONDS = implementation.MOTION_BLEND_IN_SECONDS;
pub const MOTION_BLEND_OUT_SECONDS = implementation.MOTION_BLEND_OUT_SECONDS;
