...
export const editor_painted_placements: DocIndex = {
  ...
  summary:
    'Which mesh a placed authored model renders (req_2832/2833/3133): the full-res meshdoc with the painting\'s UVs rebound onto it — except when the painting was made on a quality-DECIMATED display. mesh/painted.json stamps which doc revision the painted form belongs to; a count-mismatched painted.blob with a current stamp IS the intended exported look (renders as-is, ground-rebased; full-res doc keeps collision), while a stale/absent stamp keeps the drop-the-paint rule.',
  interfaces: [
    {
