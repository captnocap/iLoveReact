...
export const hmsc_massive_map_lab: DocIndex = {
  ...
  interfaces: [
    ...
    },
    {
      ...
      description:
        'The shared hmsc humanoid (skeleton/pose/palette in cart/hmsc/render3d/humanoid/), same model as the game and every NPC. Mounted with position=focus, yawDegrees, animationSeconds=Date.now()/1000, moving=false.',
