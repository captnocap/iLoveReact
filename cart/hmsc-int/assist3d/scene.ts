...
// The instruction contract handed to claude on the first turn (claude_code has
// no system-prompt opt). The session persists, so later turns carry only the
// request + a one-line reminder of the path.
