...
//
// Runs via: tools/v8cli cart/hmsc-int/render3d/shaders/build-shaders.ts
//
...
const ROOT = __cwd();
const SHADERS_DIR = ROOT + '/cart/hmsc-int/render3d/shaders';
...
registryOut += '// Run: tools/v8cli cart/hmsc-int/render3d/shaders/build-shaders.ts\n';
...
dispatchOut += '// Run: tools/v8cli cart/hmsc-int/render3d/shaders/build-shaders.ts\n';
