// fillShader.ts — the procedural FILL mega-shader (the effect_fills boards).
//
// ONE WGSL fragment whose D[] selects a look: D = [materialId, variant, seed,
// quality, board]. Boards A–H each own a set of materials with three variants;
...
//   D[1] variant      0 | 1 | 2 — the material's three takes
//   D[2] seed         randomization seed (any float; boards use spread formulas)
