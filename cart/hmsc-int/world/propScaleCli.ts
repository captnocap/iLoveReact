...
//
// NOT DEAD CODE: no cart imports this — its one consumer is the bash wrapper
// tools/prop-scale (which bundles it on demand). A fallow-sweep deleted it
// once for that reason (req_0618); restored under req_0619.
//
