...
// (The 'IsoAuthor uses native render drive' test was removed with IsoAuthor itself
//  — req_1967: the React build pane was deleted so the live loader pane is the one
//  build surface. LoaderIsoView's native camera drive is covered by its own path.)
