...
export const treePineGiantDef: PropKindDefinition = {
  kind: 'treePineGiant',
  label: 'Giant Pine',
  solid: true,
...
export function treePineGiantRecipe(): PropRecipe {
  const h = 32;
  const r = 0.6;
  const canopy = 3.5;
  ...
  return { id: 'treePineGiant', parts };
}

export function treePineGiantParts(): PropPartSpec[] {
  return lowerPropRecipe(treePineGiantRecipe());
}
