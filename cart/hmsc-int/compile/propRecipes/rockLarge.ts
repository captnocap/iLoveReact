...
export const rockLargeDef: PropKindDefinition = {
  kind: 'rockLarge',
  label: 'Large Rock',
  solid: true,
...
export function rockLargeRecipe(): PropRecipe {
  const h = 1.6;
  const r = 1.1;
  ...
  return { id: 'rockLarge', parts };
}

export function rockLargeParts(): PropPartSpec[] {
  return lowerPropRecipe(rockLargeRecipe());
}
