...
export const roadSignNoParkingDef: PropKindDefinition = {
  kind: 'roadSignNoParking',
...
const COLORS = {
  post: recipeColor('#74201c'),
  face: recipeColor('#c2362f'),
  trim: recipeColor('#9b2b25'),
} satisfies Record<string, Color>;

export function roadSignNoParkingRecipe(): PropRecipe {
  ...
  return { id: 'roadSignNoParking', parts };
}

export function roadSignNoParkingParts(): PropPartSpec[] {
  return lowerPropRecipe(roadSignNoParkingRecipe());
}
