...
export const roadSignBikeDef: PropKindDefinition = {
  kind: 'roadSignBike',
  label: 'Bike Sign',
  solid: true,
...
export function roadSignBikeRecipe(): PropRecipe {
  ...
  return { id: 'roadSignBike', parts };
}

export function roadSignBikeParts(): PropPartSpec[] {
  return lowerPropRecipe(roadSignBikeRecipe());
}
