...
export const roadSignPedestrianDef: PropKindDefinition = {
  kind: 'roadSignPedestrian',
...
const COLORS = {
  post: recipeColor('#1b364a'),
  face: recipeColor('#2d5a7d'),
  trim: recipeColor('#244864'),
} satisfies Record<string, Color>;

export function roadSignPedestrianRecipe(): PropRecipe {
  ...
  return { id: 'roadSignPedestrian', parts };
}

export function roadSignPedestrianParts(): PropPartSpec[] {
  return lowerPropRecipe(roadSignPedestrianRecipe());
}
