...
export const arcadePrizeDef: PropKindDefinition = {
  kind: 'arcadePrize',
  label: 'Prize Machine',
  solid: true,
...
export function arcadePrizeRecipe(): PropRecipe {
  ...
  return { id: 'arcadePrize', parts };
}

export function arcadePrizeParts(): PropPartSpec[] {
  return lowerPropRecipe(arcadePrizeRecipe());
}
