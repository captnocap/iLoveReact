...
export const slotMachinePokerDef: PropKindDefinition = {
  kind: 'slotMachinePoker',
  label: 'Video Poker Machine',
  solid: true,
...
export function slotMachinePokerRecipe(): PropRecipe {
  ...
  return { id: 'slotMachinePoker', parts };
}

export function slotMachinePokerParts(): PropPartSpec[] {
  return lowerPropRecipe(slotMachinePokerRecipe());
}
