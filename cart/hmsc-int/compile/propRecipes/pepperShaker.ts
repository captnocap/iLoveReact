...
export const pepperShakerDef: PropKindDefinition = {
  kind: 'pepperShaker',
  label: 'Pepper Shaker',
  solid: true,
...
export function pepperShakerRecipe(): PropRecipe {
  ...
  return { id: 'pepperShaker', parts };
}

export function pepperShakerParts(): PropPartSpec[] {
  return lowerPropRecipe(pepperShakerRecipe());
}
